...
simulate_trade <- function(ticker,
  ...
  # Exit scan uses the first real trading day on or after the lockup date.
  px_scan <- px_full %>%
...
# If a generic `date` column sneaks in from old code, rename/remove it.
...
# Check duplicate trade ids before creating unique index
...
# Stage in temp table and upsert
